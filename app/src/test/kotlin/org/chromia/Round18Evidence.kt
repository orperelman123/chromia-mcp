 ...
 * [Round17Evidence] applies to the round-17 tree, applied to round 18's.
 *
 ...
 * (`app/build/adversary-round18/`, gitignored) BEFORE anything is asserted, so a
 ...
 * rounds differently.
 */
object Round18Evidence {

    val committedRoot = File("src/test/resources/exploit-corpus/realworld/adversary-round18")
    val freshRoot = File("build/adversary-round18")

    private val json = Json { prettyPrint = true }

    /** Writes [fresh] to `build/adversary-round18/<relative>` and returns that file. */
    ...
    /**
     * Asserts that the recording at `build/adversary-round18/<relative>` equals
    ...
    fun assertFrozen(relative: String, fresh: JsonElement) {
        ...
        assertTrue(
            ...
            "frozen round-18 evidence missing at ${committedFile.absolutePath}; this run's recording is at " +
        ...
        assertTrue(
            differences.isEmpty(),
            "round-18 evidence drifted at $relative. The committed file is ${committedFile.absolutePath}, " +
