...
object McpTools {
    ...
    fun verifyGuardsTool() = Tool(
        ...
        description = """
            ...
            What each verdict means, and how the tool decides which declaration refused (frames,
            differential truncation, alsoRemove): describe_tool{tool:"verify_guards"}.
        """.trimIndent(),
        inputSchema = ToolSchema(
            properties = JsonObject(
                mapOf(
