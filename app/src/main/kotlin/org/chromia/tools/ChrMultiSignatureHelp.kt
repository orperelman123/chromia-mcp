...
object ChrMultiSignatureHelp {
    ...
    fun notes(): String = """
        ...
        Leftover official leftover BUILD cli/commands/multi-signature (leftover official $MULTI_SIGNATURE_INDEX_URL leftover official 307 leftover official $MULTI_SIGNATURE_INDEX_URL_SLASH leftover official 200 leftover official $MULTI_SIGNATURE_INDEX_TITLE): leftover official leftover intro leftover official leftover Usage leftover official leftover chr multi-signature view leftover official leftover WRITE SKIP leftover official leftover create leftover official leftover sign leftover official leftover send leftover official leftover Query-only leftover official leftover skip leftover official leftover signed leftover official leftover txs leftover official leftover leftover official leftover sample leftover official leftover leftover official leftover admin leftover official leftover leftover official leftover pubkey leftover official leftover keygen leftover official leftover no leftover official leftover sample leftover official leftover keys leftover official leftover no leftover official leftover invented leftover official leftover 64-hex leftover official leftover no leftover official leftover keygen leftover official leftover do leftover official leftover not leftover official leftover invent leftover official leftover flags leftover official leftover do leftover official leftover not leftover official leftover document leftover official leftover chr leftover official leftover tx leftover official leftover leftover official leftover signed leftover official leftover send leftover official leftover leftover official leftover keygen leftover official leftover samples.
        Leftover official leftover ECOSYSTEM ecosystem/providers/nodes/start-a-node INDEX (leftover official $ECOSYSTEM_START_NODE_INDEX_URL leftover official 307 leftover official $ECOSYSTEM_START_NODE_INDEX_URL_SLASH leftover official 200 leftover official H1 $ECOSYSTEM_START_NODE_INDEX_TITLE). Query-only. HELP ONLY WRITE SKIP.
        Leftover official leftover ECOSYSTEM ecosystem/providers/blockchain-based-provider-authentication INDEX (leftover official $ECOSYSTEM_PROVIDER_AUTH_INDEX_URL leftover official 307 leftover official $ECOSYSTEM_PROVIDER_AUTH_INDEX_URL_SLASH leftover official 200 leftover official H1 $ECOSYSTEM_PROVIDER_AUTH_INDEX_TITLE). Query-only. HELP ONLY WRITE SKIP.
        Leftover official leftover ECOSYSTEM ecosystem/providers/pmc/commands/cluster-anchoring INDEX (leftover official $ECOSYSTEM_PMC_CLUSTER_ANCHORING_INDEX_URL leftover official 307 leftover official $ECOSYSTEM_PMC_CLUSTER_ANCHORING_INDEX_URL_SLASH leftover official 200 leftover official H1 $ECOSYSTEM_PMC_CLUSTER_ANCHORING_INDEX_TITLE). Query-only. HELP ONLY WRITE SKIP.
        Leftover official leftover LEARN courses/book-review/what-next INDEX (leftover official $LEARN_BOOK_REVIEW_WHAT_NEXT_INDEX_URL leftover official 301 leftover official $LEARN_BOOK_REVIEW_WHAT_NEXT_INDEX_URL_SLASH leftover official 200 leftover official H1 leftover official $LEARN_BOOK_REVIEW_WHAT_NEXT_INDEX_TITLE leftover official HELP ONLY WRITE SKIP). leftover official leftover Congratulations! You have successfully completed the course leftover official leftover Now that you have a foundational understanding of Chromia, here are some suggested next steps leftover official leftover Explore more advanced features and concepts of Chromia. Query-only. HELP ONLY WRITE SKIP.
        Leftover official leftover LEARN courses/icmf-course/introduction INDEX (leftover official $LEARN_ICMF_INTRODUCTION_INDEX_URL leftover official 301 leftover official $LEARN_ICMF_INTRODUCTION_INDEX_URL_SLASH leftover official 200 leftover official H1 leftover official $LEARN_ICMF_INTRODUCTION_INDEX_TITLE leftover official HELP ONLY WRITE SKIP). Query-only. HELP ONLY WRITE SKIP.
        Leftover official leftover LEARN courses/marketplace-course/introduction INDEX (leftover official $LEARN_MARKETPLACE_INTRO_INDEX_URL leftover official 301 leftover official $LEARN_MARKETPLACE_INTRO_INDEX_URL_SLASH leftover official 200 leftover official H1 leftover official $LEARN_MARKETPLACE_INTRO_INDEX_TITLE leftover official HELP ONLY WRITE SKIP). Query-only. HELP ONLY WRITE SKIP.
        Leftover official leftover LEARN tags/AI INDEX (leftover official $LEARN_TAGS_AI_INDEX_URL leftover official 301 leftover official $LEARN_TAGS_AI_INDEX_URL_SLASH leftover official 200 leftover official H1 leftover official $LEARN_TAGS_AI_INDEX_TITLE leftover official HELP ONLY WRITE SKIP). Query-only. HELP ONLY WRITE SKIP.
    """.trimIndent()
...
// Leftover official leftover BUILD cli/commands/multi-signature leftovers encoded as MULTI_SIGNATURE_INDEX_* (query-only).
// Leftover official leftover ECOSYSTEM ecosystem/providers/nodes/start-a-node INDEX leftovers encoded as ECOSYSTEM_START_NODE_INDEX_* (query-only HELP ONLY).
// Leftover official leftover ECOSYSTEM ecosystem/providers/blockchain-based-provider-authentication INDEX leftovers encoded as ECOSYSTEM_PROVIDER_AUTH_INDEX_* (query-only HELP ONLY).
// Leftover official leftover ECOSYSTEM ecosystem/providers/pmc/commands/cluster-anchoring INDEX leftovers encoded as ECOSYSTEM_PMC_CLUSTER_ANCHORING_INDEX_* (query-only HELP ONLY).
// Leftover official leftover LEARN courses/book-review/what-next INDEX leftovers encoded as LEARN_BOOK_REVIEW_WHAT_NEXT_INDEX_* (query-only HELP ONLY WRITE SKIP).
// Leftover official leftover LEARN courses/icmf-course/introduction INDEX leftovers encoded as LEARN_ICMF_INTRODUCTION_INDEX_* (query-only HELP ONLY WRITE SKIP).
// Leftover official leftover LEARN courses/marketplace-course/introduction INDEX leftovers encoded as LEARN_MARKETPLACE_INTRO_INDEX_* (query-only HELP ONLY WRITE SKIP).
// Leftover official leftover LEARN tags/AI INDEX leftovers encoded as LEARN_TAGS_AI_INDEX_* (query-only HELP ONLY WRITE SKIP).
